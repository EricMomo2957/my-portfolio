    ...
    <section className="p-4 sm:p-6 md:p-10 max-w-6xl mx-auto space-y-10 relative">
      ...
      <div className="space-y-6 pt-6 border-t dark:border-white/10 border-slate-200/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Card 1: UI/UX Design */}
          <div className="p-5 sm:p-6 rounded-3xl dark:bg-[#07130e]/90 bg-white border dark:border-white/10 border-slate-200/90 shadow-sm dark:shadow-xl space-y-4 hover:border-[#2ecc71]/40 transition-all">
            <div className="flex items-start justify-between gap-2">
              <div>
                <h3 className="text-base font-extrabold dark:text-white text-slate-900">UI/UX Design</h3>
                <p className="text-[11px] font-mono dark:text-slate-400 text-slate-500 mt-0.5">Interface Architecture &amp; Wireframing</p>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <FaFigma size={18} className="dark:text-rose-400 text-rose-500" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Figma</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Wireframing &amp; Prototyping</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <SiCanva size={18} className="dark:text-cyan-300 text-cyan-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Canva UI</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Layouts &amp; Mockups</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-5 sm:p-6 rounded-3xl dark:bg-[#07130e]/90 bg-white border dark:border-white/10 border-slate-200/90 shadow-sm dark:shadow-xl space-y-4 hover:border-[#2ecc71]/40 transition-all">
            <div className="flex items-start justify-between gap-2">
              <div>
                ...
                <p className="text-[11px] font-mono dark:text-slate-400 text-slate-500 mt-0.5">Vector Assets &amp; Brand Visuals</p>
              </div>
              <span className="px-2.5 py-0.5 rounded-full dark:bg-white/[0.04] bg-slate-100 border dark:border-white/5 border-slate-200 text-[10px] font-mono font-bold dark:text-slate-300 text-slate-700">
                4 Tools
              </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <SiCanva size={18} className="dark:text-cyan-400 text-cyan-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Canva Pro</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Layouts &amp; Social Assets</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <FileText size={18} className="dark:text-amber-400 text-amber-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">MS PowerPoint</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Pitch Decks &amp; Vectors</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <Palette size={18} className="dark:text-blue-400 text-blue-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Photoshop</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Photo Retouch &amp; Graphics</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <Palette size={18} className="dark:text-emerald-400 text-emerald-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Photopea</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">In-Browser Graphics</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-5 sm:p-6 rounded-3xl dark:bg-[#07130e]/90 bg-white border dark:border-white/10 border-slate-200/90 shadow-sm dark:shadow-xl space-y-4 hover:border-[#2ecc71]/40 transition-all">
            <div className="flex items-start justify-between gap-2">
              <div>
                ...
                <p className="text-[11px] font-mono dark:text-slate-400 text-slate-500 mt-0.5">Motion Graphics &amp; Dynamic Cuts</p>
              </div>
              <span className="px-2.5 py-0.5 rounded-full dark:bg-white/[0.04] bg-slate-100 border dark:border-white/5 border-slate-200 text-[10px] font-mono font-bold dark:text-slate-300 text-slate-700">
                3 Tools
              </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <Sparkles size={18} className="dark:text-emerald-400 text-emerald-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">CapCut</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Short-Form &amp; Keyframes</div>
                </div>
              </div>
              ...
              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Animated Typography</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all sm:col-span-2 group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <Palette size={18} className="dark:text-rose-400 text-rose-500" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Adobe Express</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Social Media &amp; Reels</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-5 sm:p-6 rounded-3xl dark:bg-[#07130e]/90 bg-white border dark:border-white/10 border-slate-200/90 shadow-sm dark:shadow-xl space-y-4 hover:border-[#2ecc71]/40 transition-all">
            <div className="flex items-start justify-between gap-2">
              <div>
                ...
                <p className="text-[11px] font-mono dark:text-slate-400 text-slate-500 mt-0.5">IDEs, Version Control &amp; Editors</p>
              </div>
              <span className="px-2.5 py-0.5 rounded-full dark:bg-white/[0.04] bg-slate-100 border dark:border-white/5 border-slate-200 text-[10px] font-mono font-bold dark:text-slate-300 text-slate-700">
                4 Tools
              </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <Code2 size={18} className="dark:text-sky-400 text-sky-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">VS Code</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Primary Dev Studio</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <FaGitAlt size={18} className="dark:text-amber-500 text-amber-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Git &amp; GitHub</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Branches &amp; CI/CD</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <Wrench size={18} className="dark:text-emerald-400 text-emerald-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">XAMPP Stack</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Apache &amp; MySQL Local</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <Terminal size={18} className="dark:text-rose-400 text-rose-500" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Postman</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">API Testing &amp; Auth</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-5 sm:p-6 rounded-3xl dark:bg-[#07130e]/90 bg-white border dark:border-white/10 border-slate-200/90 shadow-sm dark:shadow-xl space-y-4 hover:border-[#2ecc71]/40 transition-all">
            <div className="flex items-start justify-between gap-2">
              <div>
                ...
                <p className="text-[11px] font-mono dark:text-slate-400 text-slate-500 mt-0.5">Full-Stack Frameworks, Languages &amp; Databases</p>
              </div>
              <span className="px-2.5 py-0.5 rounded-full dark:bg-white/[0.04] bg-slate-100 border dark:border-white/5 border-slate-200 text-[10px] font-mono font-bold dark:text-slate-300 text-slate-700">
                16 Tools
              </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <TbBrandCSharp size={18} className="dark:text-[#2ecc71] text-emerald-700" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">C#</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">OOP &amp; Desktop/API</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <FaCss3Alt size={18} className="dark:text-blue-400 text-blue-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">CSS3</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Modern Stylesheets</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <SiJavascript size={18} className="dark:text-[#F7DF1E] text-amber-500" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">JavaScript</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Web Logic &amp; DOM</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <FaJava size={18} className="dark:text-orange-400 text-amber-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Java</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">OOP Architecture</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <SiHtml5 size={18} className="dark:text-orange-400 text-orange-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">HTML5</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Semantic Markup</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <FaPhp size={18} className="dark:text-indigo-300 text-indigo-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">PHP</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Backend &amp; PSR-4</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <FaPython size={18} className="dark:text-sky-400 text-sky-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Python</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Data &amp; Automation</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <FaNodeJs size={18} className="dark:text-emerald-400 text-emerald-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Node.js</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Backend Runtime</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <SiBootstrap size={18} className="dark:text-purple-400 text-purple-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Bootstrap</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Responsive UI Kit</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <SiFlutter size={18} className="dark:text-sky-400 text-sky-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Flutter</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Cross-Platform Apps</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <SiMysql size={18} className="dark:text-sky-400 text-sky-700" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">MySQL</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Relational Database</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <SiSqlite size={18} className="dark:text-sky-300 text-sky-800" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">SQLite</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Embedded Database</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <FaReact size={18} className="dark:text-cyan-400 text-cyan-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">React 19</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Modern UI Library</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <SiTypescript size={18} className="dark:text-blue-400 text-blue-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">TypeScript</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Strict Typing</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <SiPostgresql size={18} className="dark:text-cyan-400 text-cyan-700" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">PostgreSQL</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Relational DB &amp; PgPool</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <SiTailwindcss size={18} className="dark:text-sky-400 text-sky-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Tailwind CSS</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Utility-First Styling</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-5 sm:p-6 rounded-3xl dark:bg-[#07130e]/90 bg-white border dark:border-white/10 border-slate-200/90 shadow-sm dark:shadow-xl space-y-4 hover:border-[#2ecc71]/40 transition-all">
            <div className="flex items-start justify-between gap-2">
              <div>
                ...
                <p className="text-[11px] font-mono dark:text-slate-400 text-slate-500 mt-0.5">Chatbot Logic, OCR &amp; Architecture</p>
              </div>
              <span className="px-2.5 py-0.5 rounded-full dark:bg-white/[0.04] bg-slate-100 border dark:border-white/5 border-slate-200 text-[10px] font-mono font-bold dark:text-slate-300 text-slate-700">
                4 Tools
              </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <Bot size={18} className="dark:text-purple-400 text-purple-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Flowise AI</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Logic-Based Chatbots</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <Cpu size={18} className="dark:text-cyan-400 text-cyan-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">Tesseract OCR</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Study Load Extraction</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <ShieldCheck size={18} className="dark:text-amber-400 text-amber-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">OOP &amp; MVC</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Structured Architecture</div>
                </div>
              </div>

              <div className="p-2.5 rounded-2xl dark:bg-[#040a07] bg-slate-50 border dark:border-white/5 border-slate-200/90 flex items-center gap-3 hover:border-[#2ecc71]/40 dark:hover:bg-[#06100b] hover:bg-slate-100/90 transition-all group/tool">
                <div className="w-9 h-9 rounded-xl dark:bg-black/40 bg-white border dark:border-white/5 border-slate-200 shadow-sm flex items-center justify-center shrink-0 group-hover/tool:scale-105 transition-transform">
                  <Layers size={18} className="dark:text-emerald-400 text-emerald-600" />
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-bold dark:text-white text-slate-900 truncate">SOLID Principles</div>
                  <div className="text-[10px] dark:text-slate-400 text-slate-500 font-mono truncate">Scalable Clean Code</div>
                </div>
              </div>
            </div>
          </div>
